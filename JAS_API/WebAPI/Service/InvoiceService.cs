                ...
                if (invoiceById != null)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            decimal? deposit = (decimal?)invoiceById.CustomerLot.Lot.Deposit ?? 0;
                            decimal? totalPrice = (decimal?)invoiceById?.TotalPrice ?? 0;
                            walletOfSeller.AvailableBalance += (deposit + totalPrice) ;
